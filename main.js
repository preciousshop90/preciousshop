...
$(document).ready(function () {
  $(document).ready(function () {
    // Handle click event of "Për Femra" link
    $("#menLink").click(function (event) {
        event.preventDefault(); // Prevent default anchor click behavior
        $('html, body').animate({
            scrollTop: $("#products").offset().top // Scroll to the top of the "products" section
        }, 500);

        // Trigger click event of the corresponding tab for "Për Femra"
        $(".nav a[href='#Men']").tab("show");
    });
  });
});
...
$(document).ready(function () {
  $(document).ready(function () {
    // Handle click event of "Për Femra" link
    $("#unisexLink").click(function (event) {
        event.preventDefault(); // Prevent default anchor click behavior
        $('html, body').animate({
            scrollTop: $("#products").offset().top // Scroll to the top of the "products" section
        }, 500);
